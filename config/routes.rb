Rails.application.routes.draw do
  namespace :api do
    ...
    get    '/show_next_js_skills/:type/:id',      to: 'react_and_next_js_skills#show'
    put    '/update_react_next_js_skills/:type/', to: 'react_and_next_js_skills#update'
    post   '/create_react_next_js_skills/:type/', to: 'react_and_next_js_skills#create'
    delete '/delete_react_next_js_skills/:type/', to: 'react_and_next_js_skills#destroy'
  end
end